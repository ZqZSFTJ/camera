...
tutorial_inferfaces__msg__Detection__init(tutorial_inferfaces__msg__Detection * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->class_name)) {
    tutorial_inferfaces__msg__Detection__fini(msg);
    return false;
  }
  // center
...
tutorial_inferfaces__msg__Detection__create()
{
  ...
  tutorial_inferfaces__msg__Detection * msg = (tutorial_inferfaces__msg__Detection *)allocator.allocate(sizeof(tutorial_inferfaces__msg__Detection), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_inferfaces__msg__Detection));
  bool success = tutorial_inferfaces__msg__Detection__init(msg);
  if (!success) {
...
tutorial_inferfaces__msg__Detection__Sequence__init(tutorial_inferfaces__msg__Detection__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_inferfaces__msg__Detection * data = NULL;

  if (size) {
    data = (tutorial_inferfaces__msg__Detection *)allocator.zero_allocate(size, sizeof(tutorial_inferfaces__msg__Detection), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_inferfaces__msg__Detection__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tutorial_inferfaces__msg__Detection__fini(&data[i - 1]);
      }
...
tutorial_inferfaces__msg__Detection__Sequence__fini(tutorial_inferfaces__msg__Detection__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_inferfaces__msg__Detection__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_inferfaces__msg__Detection__Sequence * array = (tutorial_inferfaces__msg__Detection__Sequence *)allocator.allocate(sizeof(tutorial_inferfaces__msg__Detection__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_inferfaces__msg__Detection__Sequence__init(array, size);
  if (!success) {
...
tutorial_inferfaces__msg__Detection__Sequence__destroy(tutorial_inferfaces__msg__Detection__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_inferfaces__msg__Detection__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_inferfaces__msg__Detection__Sequence__are_equal(const tutorial_inferfaces__msg__Detection__Sequence * lhs, const tutorial_inferfaces__msg__Detection__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_inferfaces__msg__Detection__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_inferfaces__msg__Detection__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_inferfaces__msg__Detection);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_inferfaces__msg__Detection * data =
      (tutorial_inferfaces__msg__Detection *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_inferfaces__msg__Detection__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_inferfaces__msg__Detection__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_inferfaces__msg__Detection__copy(
