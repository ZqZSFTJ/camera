...
{
  new (message_memory) tutorial_inferfaces::msg::Detection(_init);
}

void Detection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_inferfaces::msg::Detection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection_message_member_array[2] = {
  {
    ...
    offsetof(tutorial_inferfaces::msg::Detection, class_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_inferfaces::msg::Detection, center),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection_message_members = {
  "tutorial_inferfaces::msg",  // message namespace
  "Detection",  // message name
  2,  // number of fields
  sizeof(tutorial_inferfaces::msg::Detection),
...
{
  return &::tutorial_inferfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_inferfaces, msg, Detection)() {
  return &::tutorial_inferfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
