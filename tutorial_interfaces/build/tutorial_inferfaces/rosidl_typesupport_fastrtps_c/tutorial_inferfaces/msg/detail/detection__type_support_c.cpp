...
#include "tutorial_inferfaces/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
#include "tutorial_inferfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_tutorial_inferfaces
...
using _Detection__ros_msg_type = tutorial_inferfaces__msg__Detection;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_inferfaces
size_t get_serialized_size_tutorial_inferfaces__msg__Detection(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection__ros_msg_type * ros_message = static_cast<const _Detection__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_inferfaces__msg__Detection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_inferfaces
size_t max_serialized_size_tutorial_inferfaces__msg__Detection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_inferfaces__msg__Detection;
    is_plain =
      (
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_inferfaces__msg__Detection(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_inferfaces, msg, Detection)() {
